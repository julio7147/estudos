<?php   
    ...
    $depoimentos = Painel::selectAll('tb_admin.depoimentos',($paginaAtual - 1) * $porPagina,$porPagina);
...
<div class="check">
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="<?php echo INCLUDE_PATH_PAINEL ?>listar-depoimentos?order=up&id=<?php echo $value['id'] ?>" ><img src="img/pra-cima.png" /></a></td>
            <td><a class="giro" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-depoimentos?order=dowm&id=<?php echo $value['id'] ?>" ><img src="img/pra-cima.png" /></a></td>
...
<div class="paginacao">
   <?php
        $totalPaginas = ceil(count(Painel::selectAll('tb_admin.depoimentos')) / $porPagina);
