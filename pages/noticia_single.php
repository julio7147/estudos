    ...
    <div class="center">
		...
		?>
			<div class="container-erro-login">
				<p><i></i>Você precisa estar logado para comentar, clique<a href="<?php echo INCLUDE_PATH ?>painel">aqui</a>para efetuar o login.</p>
			</div>
		<?php	
		}else{?>
			<?php
			//inserção dos comentarios no banco de dados
			...
			<form method="post">
				...
				<textarea placeholder="Seu comentario..."></textarea>
